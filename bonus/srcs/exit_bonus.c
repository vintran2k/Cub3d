...
/*   Updated: 2021/03/25 01:39:41 by vintran          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mlx_destroy(t_var *var)
{
	...
	if (var->texture[5].img)
		mlx_destroy_image(var->mlx.mlx_ptr, var->texture[5].img);
	if (var->texture[6].img)
		mlx_destroy_image(var->mlx.mlx_ptr, var->texture[6].img);
	if (var->mlx.mlx_win)
